...
<body>
    ...
    <header class="p-5 mb-4 bg-secondary rounded-bottom">
        <section class="container-fluid py-5">
            <h1 class="display-5 fw-bold mb-5">MonBlog - <?php echo $ficheArticle['titre']; ?></h1>
            
            <?php
            if (estConnecte() && estAdmin()) {
                echo '<a href="modif-article.php?id_article=' . $ficheArticle['id_article'] . '" class="btn btn-primary btn-lg">Modification d\'un article</a>';
            }
            ?>
        </section>
    </header>
